...
import user from "../../img/sylvain-mauroux-OIuzDRYA3cw-unsplash.jpg"


function User() {
  return (
    <>
          <body class="container mx-auto font-sans antialiased inset-0 z-0 text-gray-900 leading-normal tracking-wider bg-cover"
        ...
        <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            ...
            <div id="profile"
                ...
                <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <h1 class="text-3xl font-bold pt-8 lg:pt-0">Имя</h1>
