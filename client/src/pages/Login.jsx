    ...
    <div className="w-full">
        ...
        <div className="mt-5">
            <form action="">
                ...
                <p className="text-center text-sm text-gray-500">У вас нет аккаунта ?
                    <span
                        className="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none"><Link to="/register"> Зарегистрируйтесь</Link>
                    </span>.
                </p>
            </form>
            </div>
