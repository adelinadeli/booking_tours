...
const Login = () => {
    ...
    <div class="w-full">
        <div class="text-center">
            <h1 class="text-3xl font-semibold text-gray-900">Авторизация</h1>
        ...
        <div class="mt-5">
            <form action="">
                ...
                <div class="relative mt-6">
                    ...
                    onChange={handleChange} placeholder="login" class="peer peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" />
                ...
                <div class="relative mt-6">
                    <input type="password" name="password" id="password" onChange={handleChange} placeholder="Password" class="peer peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" />
                ...
                <div class="my-6">
                    <button onClick={handleSubmit} type="submit" class="w-full rounded-md bg-black px-3 py-4 text-white focus:bg-gray-600 focus:outline-none">Авторизоваться</button>
                    {err && <p>{err}</p>}
                </div>

                <p class="text-center text-sm text-gray-500">У вас нет аккаунта ?
                    <a href="#!"
                        class="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none"><Link to="/register"> Зарегистрируйтесь</Link>
                    </a>.
                </p>
            </form>
            </div>
